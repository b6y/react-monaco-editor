...
export declare type ChangeHandler = (value: string, event: monacoEditor.editor.IModelContentChangedEvent) => void;
export declare type EditorDidMount = (editor: monacoEditor.editor.IStandaloneCodeEditor, monaco: typeof monacoEditor) => void;
export declare type EditorWillMount = (monaco: typeof monacoEditor) => void | monacoEditor.editor.IEditorConstructionOptions;
declare interface MonacoEditorBaseProps {
    ...
    requireConfig?: any;
    /**
     * Optional, allow to pass a different context then the global window onto which
     * the monaco instance will be loaded. Useful if you want to load the editor in an iframe.
     */
    context?: any;
}
...
export declare type DiffEditorDidMount = (editor: monacoEditor.editor.IStandaloneDiffEditor, monaco: typeof monacoEditor) => void;
export declare type DiffEditorWillMount = (monaco: typeof monacoEditor) => void;
export declare type DiffChangeHandler = (value: string) => void;
...
export declare class MonacoDiffEditor extends React.Component<MonacoDiffEditorProps> {
